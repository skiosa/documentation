...
% Note: This should be removed as soon as section 5.2 is created
\begin{table}[h]
    \resizebox{\textwidth}{!}{\begin{tabular}{|p{8cm}|p{8cm}|}
    \hline
    Beschreibung der Änderung & Begründung der Änderung\\ \hline
    In der Plattform werden RSS Feeds keinen Inhalt anzeigen & Ein Großteil der im Internet vohandenen RSS Feeds verlinken nur auf Artikel und enthalten keinen Inhalt, was das Darstellen unmöglich macht. \\ 
