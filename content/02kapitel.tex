...
\subsection{TypeORM}
    ...
    aber auch gleichzeitig für den Programmcode. Um unsere Klassen auch für GrapQL zuverwenden nutzen wir zusätzlich TypeGraphQL, welches Klassen automatisch in GraphQL Objekte konvertiert.
...
\subsection{Jira}
    ...
    Für unsere Projekt wurde auch das Kanban Board verwendet, diese hatte mehrere Swimlanes, welche den Status eines Tickets präsentiert haben.
    Des weiteren haben wir in den einzelnen Swimlanes \ac{WIP} genutzt um einen Projekt Fluss zu gewährleisten. 
\subsection{Github(Pull Requests)}
    ...
    geht das Ticket von \textit{Open} in den Status \textit{In Progress}. Anschließend wenn ein Pull-Request eröffnet wird welchen den Branch beihnaltet der dem Ticker zugeordnet ist,
...
\subsection{Figma}
    ...
    Vor einer Feature Implementierung in der Softwre wurde zurerst immer ein Mockup in Figma dafür erstellt.
