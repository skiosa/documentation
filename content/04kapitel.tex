...
\begin{quotation}
    ...
    \begin{itemize}
        ...
        \item etc.
    \end{itemize}
    More Information for how to create common components can be found at https://help.figma.com/hc/en-us/articles/360038662654-Guide-to-Components-in-Figma \\
    \textbf{Ideas for a possible solution}
    \begin{itemize}
        \item Look at design guidelines for fonts, separation, etc. (should comply with it)
        \item Possibly copy some ideas from mockups you can find on the internet: ex. https://www.behance.net/gallery/104152447/Mobile-App-Design-Challenge-Figma-Free-UXUI-2 \\
    \end{itemize}
    \textbf{Acceptance Criteria}
    \begin{itemize}
        \item The components above have common components in figma
        \item Components are in a seperate page in figma (see https://help.figma.com/hc/en-us/articles/360038511293-Create-and-Manage-Pages) \\
    \end{itemize}
\end{quotation}
Bearbeitet von Sabrina Ladner.
Reviewed von Amos Groß.
