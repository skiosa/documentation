...
\begin{quotation}
    ...
    \begin{itemize}
        ...
        https://www.behance.net/gallery/104152447/Mobile-App-Design-Challenge-Figma-Free-UXUI-2 \\
    \end{itemize}
    \textbf{Acceptance Criteria}
    \begin{itemize}
        \item The components above have common components in figma
        \item Components are in a seperate page in figma
        (see https://help.figma.com/hc/en-us/articles/360038511293-Create-and-Manage-Pages) \\
    \end{itemize}
\end{quotation}
Bearbeitet von Sabrina Ladner.
Reviewed von Amos Groß.
