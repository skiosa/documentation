...
\section{Architektur}
Um unsere Produkt der öffentlichkeit zugänglich zu machen, heißt live Hosten und dabei auch einen angehenmen Workflow\footnote{Arbeitsablauf} für die Entwickler bereitzustellen, haben wir uns entschieden einen Server in der Cloud zu mieten um dies zu erfüllen.
Dabei läuft auf dem Server ein leichgewichtiges Kubernetes System welches sich \textit{k3s}~\parencite{web/k3s} nennt. Dies bietet für uns alle Kubernetes möglichkeiten und ist dabei sehr einfach zu verwalten. 
