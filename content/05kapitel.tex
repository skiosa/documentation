...
Eine Design-Language kann als Framework verstanden werden, das Teams ermöglicht, 
...
Im engeren Sinne kann eine Design-Language ein Set von Regeln, die Typografie, Formen und Muster vorschreiben.
...
Dabei kann einem RSS-Feed ein eigener Namen und Beschreibung gegeben werden.(vgl. Abbildung~\ref{fig:Add Feed Desktop Light}) 
\begin{figure}[H]
