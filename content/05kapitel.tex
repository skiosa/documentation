...
\begin{table}[h]
    ...
    In der Plattform werden RSS Feeds keinen/wenig Inhalt anzeigen & Ein Großteil der im Internet vohandenen RSS Feeds verlinken nur auf Artikel und enthalten keinen Inhalt. \\ 
